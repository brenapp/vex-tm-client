...
export type ManualAuthorizationConfig = {
    getBearer: () => Promise<BearerResult>;
};
...
export class Client {
    ...
    getAuthorizationHeaders(
        ...
        const signature = createHmac("sha256", this.connectionArgs.clientAPIKey)
            .update(stringToSign)
            .digest("hex");
